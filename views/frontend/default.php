...
<div class="wrap mni-free-default-form">
    <form id="mni-default-anonymous-form" class="mni-free-form" method="post" enctype="multipart/form-data">
        ...
        <label for="mni-free-default-message"><?php esc_html_e('Your Message', 'messengernotifier'); ?></label>
        <textarea id="mni-free-default-message" class="mni-textarea" name="message" required rows="5" style="width: 100%;"></textarea>
